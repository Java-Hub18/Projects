...
<br>
	...
	<section class="signup">
		...
		<td> 
		<a href="${pageContext.request.contextPath}/file-upload/downloadFile/${theEmployee.fileName}">Download</a>
		| <a href="${pageContext.request.contextPath}/file-upload/removeFile/${theEmployee.id}/${theEmployee.fileName}" onclick="return confirm('Are you sure you want to delete ${theEmployee.name}?');">Delete</a>
		</td>
					</tr>
				</c:forEach>
				</c:when>
				...
				<div style="display: flex; justify-content: space-between;">
						<a href="${pageContext.request.contextPath}/file-upload/employees"
							class="signup-image-link">View Employees</a> <a
							href="${pageContext.request.contextPath}/file-upload/home"
